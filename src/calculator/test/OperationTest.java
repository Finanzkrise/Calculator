...
public class OperationTest {
    ...
    void testisNumberOneHigherThanNumberTwoIntInt() {
        ...
        assertEquals(true, new Addition().isNumberOneHigherThanNumberTwo(decimal1, decimal2));
        assertEquals(false, new Addition().isNumberOneHigherThanNumberTwo(decimal2, decimal1));
    }
    @Test
